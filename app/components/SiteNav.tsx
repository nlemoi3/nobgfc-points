...
export default function SiteNav() {
  return (
    ...
    >
      <strong style={{ marginRight: "20px" }}>NOBGFC</strong>

      <Link href="/dashboard" style={{ marginRight: "18px" }}>
        Dashboard
      </Link>
      ...
      <NavGroup title="Admin">
        <div><Link href="/admin">Admin Dashboard</Link></div>
        ...
        <div><Link href="/admin/awards">Angler Awards</Link></div>
        <div><Link href="/admin/boat-awards">Boat Awards</Link></div>
